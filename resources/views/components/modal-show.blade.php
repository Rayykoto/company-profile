...
$(document).ready(function(){
    $('#DataEvent').on('show.bs.modal', function (e) {
        ...
        document.getElementById("event_name").innerHTML = '<h3 style="color:blue;">'+event_name+'</h3>';
        document.getElementById("event_image").innerHTML = '<img src="'+event_image+'" class="img-fluid">';
        document.getElementById("event_start").innerHTML ='<label class="pt-3">Start Date : '+event_start+'</label>';
